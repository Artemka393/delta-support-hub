...
## Почему подходит под вакансию

Проект отражает реальные задачи junior-разработчика в поддержке: разбор пользовательских проблем, автоматизация повторяющихся действий, работа с данными, развитие full-stack навыков на Microsoft-стеке и понятный Vue-интерфейс для внутренних пользователей.
